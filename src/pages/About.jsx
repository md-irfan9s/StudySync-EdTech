...
import Quote from "../components/core/AboutPages/Quote";
import FoundingStory from "../assets/Images/FoundingStory.png"
import StatsComponent from "../components/core/AboutPages/StatsComponent";
...
const About = () => {
    ...
    return (
      ...
      <section className="mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10">
        <LearningGrid />
